...
Partial Class ScannerUI
    ...
    Private Sub InitializeComponent()
        ...
        Me.RP_Setup_Text = New Telerik.WinControls.UI.RadPanel()
        Me.WB_Introduction = New System.Windows.Forms.WebBrowser()
        Me.RP_Setup_Buttons = New Telerik.WinControls.UI.RadPanel()
        ...
        Me.RP_Done_Text = New Telerik.WinControls.UI.RadPanel()
        Me.RL_Done = New Telerik.WinControls.UI.RadLabel()
        Me.RP_Done_Buttons = New Telerik.WinControls.UI.RadPanel()
        ...
        CType(Me.RP_Setup_Text, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.RP_Setup_Text.SuspendLayout()
        CType(Me.RP_Setup_Buttons, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.RP_Setup_Buttons.SuspendLayout()
        ...
        CType(Me.RP_Done_Text, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.RP_Done_Text.SuspendLayout()
        CType(Me.RL_Done, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.RP_Done_Buttons, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.RP_Done_Buttons.SuspendLayout()
        ...
        Me.RP_Setup_Buttons.Controls.Add(Me.RTB_DbgPath)
        Me.RP_Setup_Buttons.Controls.Add(Me.RB_Continue)
        ...
        Me.__DBG_RemoveJunctions.UseCompatibleTextRendering = False
        '
        '__DBG_SEP2
        '
        resources.ApplyResources(Me.__DBG_SEP2, "__DBG_SEP2")
        Me.__DBG_SEP2.Name = "__DBG_SEP2"
        Me.__DBG_SEP2.UseCompatibleTextRendering = False
        '
        ...
        Me.__DBG_CopyFeatureList.UseCompatibleTextRendering = False
        '
        '__DBG_SEP4
        '
        resources.ApplyResources(Me.__DBG_SEP4, "__DBG_SEP4")
        Me.__DBG_SEP4.Name = "__DBG_SEP4"
        Me.__DBG_SEP4.UseCompatibleTextRendering = False
        '
        ...
        Me.__DBG_SendToastNotification.UseCompatibleTextRendering = False
        '
        ...
        CType(Me.RP_Setup_Text, System.ComponentModel.ISupportInitialize).EndInit()
        Me.RP_Setup_Text.ResumeLayout(False)
        CType(Me.RP_Setup_Buttons, System.ComponentModel.ISupportInitialize).EndInit()
        Me.RP_Setup_Buttons.ResumeLayout(False)
        Me.RP_Setup_Buttons.PerformLayout()
        ...
        CType(Me.RP_Done_Text, System.ComponentModel.ISupportInitialize).EndInit()
        Me.RP_Done_Text.ResumeLayout(False)
        CType(Me.RL_Done, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.RP_Done_Buttons, System.ComponentModel.ISupportInitialize).EndInit()
        Me.RP_Done_Buttons.ResumeLayout(False)
        Me.RP_Done_Buttons.PerformLayout()
    ...
    Friend WithEvents RP_Setup_Buttons As RadPanel
    Friend WithEvents __DBG_OPTIONS As RadDropDownButton
    Friend WithEvents __DBG_UnlockAllTabs As RadMenuItem
    Friend WithEvents __DBG_SEP1 As RadMenuSeparatorItem
    Friend WithEvents __DBG_AddJunctions As RadMenuItem
    Friend WithEvents __DBG_RemoveJunctions As RadMenuItem
    Friend WithEvents __DBG_SEP2 As RadMenuSeparatorItem
    Friend WithEvents __DBG_TestSymDownloadedText As RadMenuItem
    Friend WithEvents __DBG_ScanSymbols As RadMenuItem
    Friend WithEvents __DBG_SEP3 As RadMenuSeparatorItem
    Friend WithEvents __DBG_CopyFeatureList As RadMenuItem
    Friend WithEvents __DBG_SEP4 As RadMenuSeparatorItem
    Friend WithEvents __DBG_SendToastNotification As RadMenuItem
    Friend WithEvents RB_SymbolPath_Browse As RadButton
    Friend WithEvents RB_DbgPath_Browse As RadButton
    Friend WithEvents RP_Setup_Text As RadPanel
    Friend WithEvents WB_Introduction As WebBrowser
    Friend WithEvents RB_Continue As RadButton
    Friend WithEvents RL_SymbolPath As RadLabel
    Friend WithEvents RL_DbgPath As RadLabel
    Friend WithEvents RTB_SymbolPath As RadTextBox
    Friend WithEvents RTB_DbgPath As RadTextBox
    Friend WithEvents RP_Done_Text As RadPanel
    Friend WithEvents RL_Done As RadLabel
    Friend WithEvents RP_Done_Buttons As RadPanel
    Friend WithEvents RL_OA As RadLabel
    Friend WithEvents RB_OA_CopyFeaturesTXT As RadButton
    Friend WithEvents RL_OutputFile As RadLabel
    Friend WithEvents RB_OA_DeleteSymbolPath As RadButton
End Class
