...
Partial Public Class CrashReporter
    ...
    Private Shared Sub SendReport(exception As Exception)
        Dim reportCrash = New ReportCrash(Nothing) With {
            ...
            .DeveloperMessage = "Application Settings:" & Environment.NewLine & "AutoLoad: " & My.Settings.AutoLoad & Environment.NewLine & "Dark Mode: " & My.Settings.DarkMode & Environment.NewLine & "Use System Theme: " & My.Settings.UseSystemTheme & Environment.NewLine & "User Langauge: " & My.Settings.TwoCharLanguageCode
        }
