...
Embed_Help.add_field(name='/comment get <Build>', value='''Gets a Table of every Comment for that Build only works in <#992320061144571964>)
Example: `/comment get 25151`''', inline=False)
Embed_Help.add_field(name='/comment add <Build> <FeatureName> "<Comment>"', value='''Adds a Comment to the specified Build and Feature (only works in <#992320061144571964>)
Example: `/comment add 25151 Feature1 "This appears as a comment"`''', inline=False)
Embed_Help.add_field(name='/comment edit <Build> <FeatureName> "<Comment>"', value='''Edits a comment from the specified Build and Feature (only works in <#992320061144571964>)
Example: `/comment edit 25151 Feature1 "Edited comment"`''', inline=False)
Embed_Help.add_field(name="/comment remove <Build> <FeatureName>", value='''Removes a comment from the specified Build and Feature (only works in <#992320061144571964>)
Example: `/comment remove 25151 Feature1`''', inline=False)
